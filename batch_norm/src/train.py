...
def train():
    ...
    for epoch in range(cfg.num_epochs):
        ...
        bn_val_losses.append(bn_val_loss)

    return base_train_losses, base_val_losses, bn_train_losses, bn_val_losses
...
if __name__ == '__main__':
    base_train_losses, base_val_losses, bn_train_losses, bn_val_losses = train()
    plot_losses(base_train_losses, base_val_losses, bn_train_losses, bn_val_losses)